	...
	<body style="background-color:#EEEEEE">
		...
		<div class="bodyStyle">
			<div >
				...
				<div style="font:30px/350px 'microsoft yahei';color:#333333">邮件发送成功，立即<s:a onmouseover="this.style.color='#eb4a3f'" cssStyle="color:#333333;text-decoration:underline" href="http://%{#request.email}" >登录邮箱</s:a>查看！</div>
			</div>
		</div>
