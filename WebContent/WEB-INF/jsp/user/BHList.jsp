		...
		<div class="uc_frame">
			...
			<script type="text/javascript">
				$(".c_delete_c").click(function(){
					...
					$.ajax({
						...
						url:'<s:property value="@com.haozhuoji.mall.util.Constant@user_p" />/goods_deleteBH.html',
			...
			<div style="float:right">
				<s:if test="page.currentPage>1">
					<a class="nextPre" href="<s:property value="@com.haozhuoji.mall.util.Constant@user_p+'/goods_BHList.html?page.currentPage='+(page.currentPage-1)" />" id="c_nextPre" style="float:left;margin:10px;padding:5px;width:50px;border:1px solid #dddddd;background-color:#eeeeee;text-align:center;color:#666666;cursor:pointer">上一页</a>
				</s:if>
				<s:if test="page.currentPage<page.totalPage">
					<a class="nextPre" href="<s:property value="@com.haozhuoji.mall.util.Constant@user_p+'/goods_BHList.html?page.currentPage='" /><s:property value="page.currentPage+1"/>" id="c_nextPre" style="float:left;margin:10px;padding:5px;width:50px;border:1px solid #dddddd;background-color:#eeeeee;text-align:center;color:#666666;cursor:pointer">下一页</a>
				</s:if>
			</div>
			</div>
		</div>
