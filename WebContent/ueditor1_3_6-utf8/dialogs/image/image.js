...
(function () {
                            ...
                            onsuccess:function (xhr) {
                                ...
                                for (var k = 0, ci; ci = imageUrls[k++];) {
									...
									img.oncontextmenu=function(){
										g("g_delete").style.display="block";
										g("g_delete").style.left=this.offsetLeft+"px";
										g("g_delete").style.top=this.offsetTop+(this.offsetHeight-20)/2+"px";
										g("g_delete").style.width=this.offsetWidth+"px";
										//alert(this.offsetLeft);
										g("imageList").onclick=function(){
											g("g_delete").style.display="none";
											return false;
										};
										var imgd = this;
										g("g_delete").onclick=function(){
											var src = imgd.getAttribute("src").split("/");
											UE.ajax.request("goods_deletePageImg.html",{data:{upfileFileName:src[src.length-1],goodsID:src[src.length-3]}});
											imgd.parentNode.parentNode.removeChild(imgd.parentNode);
											g("g_delete").style.display="none";
										};
										return false;
									};
                                    ...
                                    if(img.getAttribute("src").indexOf("main_500x500.jpg")>0){
							            img.style.cssText = "filter:alpha(Opacity=100);-moz-opacity:1;opacity: 1;border: 2px solid red";
						            }else if(img.getAttribute("src").indexOf("500x500.jpg")>0){
							            img.style.cssText = "filter:alpha(Opacity=100);-moz-opacity:1;opacity: 1;border: 2px solid green";						            	
						            }
                                }
                            },
                            onerror:function () {
    ...
    function changeSelected(o) {
        if (o.getAttribute("selected")) {
            ...
            if(o.getAttribute("src").indexOf("main_500x500.jpg")>0){
	            o.style.cssText = "filter:alpha(Opacity=100);-moz-opacity:1;opacity: 1;border: 2px solid red";
            }else if(o.getAttribute("src").indexOf("500x500.jpg")>0){
	            o.style.cssText = "filter:alpha(Opacity=100);-moz-opacity:1;opacity: 1;border: 2px solid green";
            }else{
